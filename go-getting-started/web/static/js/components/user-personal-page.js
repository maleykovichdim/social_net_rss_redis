 ...
 */
 async function follow(friend_id) {
    return doPost('/api/auth_user/follow', { friend_id })
}
 ...
 */
 async function isFollowee(followee_id) {
    return doGet('/api/auth_user/is_followee?followee_id='+ followee_id )
}
